...
locationSelector.addEventListener('change', function() {
    ...
    // Send the selected locations to the iframe
    var trafficIframe = document.getElementById('traffic-iframe');
    trafficIframe.contentWindow.postMessage(locations, '*');
    trafficIframe.contentWindow.postMessage({ action: 'updateLocations', locations: locations }, '*');
